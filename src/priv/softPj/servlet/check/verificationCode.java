...
public class verificationCode extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String verificationString = "abcdefghijklmnopqrstuvwsyz1234567890ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            String code = verificationString.charAt(randNum(0, verificationString.length() - 1)) + "";
