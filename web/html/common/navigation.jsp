...
<nav>
    <div id="navigation">
        ...
        <a href="html/browser.jsp">Browser</a>
    ...
    <c:if test="${sessionScope.UID!=null}">
        <div id="userMenu"><span>UserCenter</span>
            <ul>
                ...
                <li><a href="favor.jsp"><img src="img/icon/favored.png" alt="favor" class="icon">MyFavor</a>
                </li>
                <li><a href="logout"><img src="img/icon/logout.png" alt="logout" class="icon"> Logout</a>
                </li>
            </ul>
        </div>
    </c:if>
